name: Bug 反馈
description: 在使用 IslandCaller 的过程中遇到了 Bug。
title: （将此栏【替换】为你的标题）
...
body:
  ...
  - type: checkboxes
    ...
    attributes:
      ...
      options:
        - label: 我已更新到最新版 ![最新的版本号](https://img.shields.io/github/v/release/HUSX100/IslandCaller?include_prereleases&style=flat-square&label=) ，并看过[最新提交](https://github.com/HUSX100/IslandCaller/commits/dev/)，确认这一 Bug 还没有修复。我也已在 [Issues](https://github.com/HUSX100/IslandCaller/issues?q=type%3ABug) 中检索，确认这一 Bug 未被提交过。
          required: true
  ...
  - type: input
    ...
    attributes:
      label: 应用版本
      description: 您当前使用的 Island 版本号，可以在【插件】->【IslandCaller】中查看。
      placeholder: 如：1.0.0.0
    validations:
      required: true
  - type: input
    id: os_version
